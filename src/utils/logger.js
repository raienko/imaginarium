const stylesheet = {
  warning:
    'background: #fde400; padding: 5px; border-radius: 3px; color: #cdb203;',
  success:
    'background: #3bbd79; padding: 5px; color: white; border-radius: 3px;',
  ...
  failed: 'background: red; padding: 3px; border-radius: 3px; color: white;',
};
...
export default new (class Logger {
  ...
  failed = (...data) => this.prefixedLog(stylesheet.failed, '--X', ...data);

  help = () => {
    this.log(
      'This is extended logger that adds custom styles and prevents console.logs in release',
    );
    this.log('Logger.log');
